...
class peminjamancontroller extends Controller
{
    ...
    if(Auth::user()->level=="admin"){
      ...
      'peminjaman.id_petugas','peminjaman.tgl_pinjam','peminjaman.deadline','peminjaman.denda')
      ->get();
  ...
  public function tampil_pinjam(){
    ...
    ->join('anggota','anggota.id','=','peminjaman.id_anggota')
    ->join('petugas','petugas.id','=','peminjaman.id_petugas')
    ->select('peminjaman.id','anggota.nama_anggota','anggota.alamat',
    'anggota.telp','petugas.nama_petugas','peminjaman.tgl_pinjam',
